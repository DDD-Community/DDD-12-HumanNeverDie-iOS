...
struct AMDBeverageListDemoView: View {
  ...
  @ViewBuilder
  private func largeBeverageItem(for index: Int) -> some View {
  ...
  @ViewBuilder
  private func mediumBeverageItem(for index: Int) -> some View {
  ...
  @ViewBuilder
  private func smallBeverageItem(for index: Int) -> some View {
