...
@DependencyClient
public struct BeverageRepositoryInterface: Sendable {
  public var getBeverageCount: @Sendable () async throws -> BeverageCount
  public var getBeverageList: @Sendable (_ cursor: String?, _ sugarLevel: String?, _ onlyLiked: Bool) async throws -> BeverageList
  ...
  public var searchBeverage: @Sendable (_ keyword: String, _ sugarLevel: String?, _ onlyLiked: Bool) async throws -> BeverageList
  public var recordBeverage: @Sendable (_ productID: String, _ recordDate: Date, _ size: String) async throws -> Int
  public var deleteBeverage: @Sendable (_ productID: String, _ intakeTime: String) async throws -> Int
}
